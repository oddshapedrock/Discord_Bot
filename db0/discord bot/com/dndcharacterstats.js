	...
	callback: async (message, arguments, text) => {
		...
		if (arguments[0] == null) {
			...
			if (low == 'info') {
				...
				//information
				embed.addFields(
					{name: '⠀', value: '⠀⠀⠀💪 Strength:\n⠀⠀⠀💨 Dextarity:\n⠀⠀⠀:shield: Constitution:', inline: true},
					{name: '**-Attributes-**', value: `${attributes.strength}⠀⠀⠀⠀⠀📚 Intelligence:\n${attributes.dexterity}⠀⠀⠀⠀⠀👴 Wisdom:\n${attributes.constitution}⠀⠀⠀⠀⠀🎲 Charisma:`, inline: true},
					{name: '⠀', value: `${attributes.intelligence}\n${attributes.wisdom}\n${attributes.charisma}`, inline: true},
					
					{ name: '⠀', value: '⠀', inline: false},
					
					{name: '⠀', value: '⠀⠀⠀Strength:\n⠀⠀⠀Dextarity:\n⠀⠀⠀Constitution:', inline: true},
					{name: '⠀**-Saves-**', value: `${save[0]}⠀⠀⠀⠀⠀Intelligence:\n${save[1]}⠀⠀⠀⠀⠀Wisdom:\n${save[2]}⠀⠀⠀⠀⠀Charisma:`, inline: true},
					{name: '⠀', value: `${save[3]}\n${save[4]}\n${save[5]}`, inline: true},
					
					{ name: '⠀', value: '⠀', inline: false},
					
					{ name: '⠀', value:  '⠀⠀⠀Acrobatics:\n⠀⠀⠀Animal Handling:\n⠀⠀⠀Arcana:\n⠀⠀⠀Athletics:\n⠀⠀⠀Deception:\n⠀⠀⠀History:\n⠀⠀⠀Insight:\n⠀⠀⠀Intimidation:\n⠀⠀⠀Investigation', inline: true},
					{ name: '⠀**-Skills-**', value:  `${skill0[0]}⠀⠀⠀⠀⠀⠀Medicine:\n${skill0[1]}⠀⠀⠀⠀⠀⠀Nature:\n${skill0[2]}⠀⠀⠀⠀⠀⠀Perception:\n${skill0[3]}⠀⠀⠀⠀⠀⠀Performance:\n${skill0[4]}⠀⠀⠀⠀⠀⠀Persuasion:\n${skill0[5]}⠀⠀⠀⠀⠀⠀Religoin:\n${skill0[6]}⠀⠀⠀⠀⠀⠀Sleight of Hand:\n${skill0[7]}⠀⠀⠀⠀⠀⠀Stealth:\n${skill0[8]}⠀⠀⠀⠀⠀⠀Survival:`, inline: true},
					{ name: '⠀', value:  `${skill0[9]}\n${skill0[10]}\n${skill0[11]}\n${skill0[12]}\n${skill0[13]}\n${skill0[14]}\n${skill0[15]}\n${skill0[16]}\n${skill0[17]}`, inline: true},
				...
				for(var i = 0; i < weapons.length; i++){
					weapons2.push({ name: `${weapons[i].name}`, value: `${weapons[i].description}`, inline: true})
				}
				if(items.length == 0)
				{
					weapons2.push({ name: `Uh Oh!`, value: `I was unable to find any weapons for this character!`, inline: true})
				}
				...
				for(var i = 0; i < items.length; i++){
					items2.push({ name: `${items[i].name}`, value: `${items[i].description}`, inline: true})
				}
				if(items.length == 0)
				{
					items2.push({ name: `Uh Oh!`, value: `I was unable to find any items for this character!`, inline: true})
				}
				...
				embed.addFields(
					...
					{name: '⠀⠀ **-Money-**', value: `💵 Copper:\n💰 Silver:\n💩️ Electrum:\n🪙 Gold:\n💎 Platinum:`, inline: true},
					{name: '⠀', value: `${value.copper}\n${value.silver}\n${value.electrum}\n${value.gold}\n${value.platinum}`, inline: true},
				)
