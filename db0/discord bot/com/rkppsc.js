module.exports = {
	...
	callback: (message, arguments, text) => {
		...
		if (!choices.includes(playerChoice) || !playerChoice) {
			...
			let emote = {rock: '🪨', paper: '📰', scissors: '✂️'}
			
			const Discord = require('discord.js');
			
			const field = 	({ name: 'You', value: (emote[playerChoice]), inline: true })
			const field2 =	({ name: '--->', value: "VS.", inline: true })
			const field3 =	({ name: `Bot`, value: (emote[botChoice]), inline: true })
